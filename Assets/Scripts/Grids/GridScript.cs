...
public class GridScript : MonoBehaviour {
	...
	public virtual void SpawnStartPositions() { 
		foreach(Vector3 pos in start) 
			Instantiate(startSprite, gridArray[(int)pos.x, (int)pos.y].transform.position, Quaternion.identity);
